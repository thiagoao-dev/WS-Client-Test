 ...
 * 
 */
@WebServiceClient(name = "UsuarioWS", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/ServerWS/UsuarioWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USUARIOWS_QNAME = new QName("http://ws/", "UsuarioWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServerWS/UsuarioWS?wsdl");
    ...
    public UsuarioWS getUsuarioWSPort() {
        return super.getPort(new QName("http://ws/", "UsuarioWSPort"), UsuarioWS.class);
    }
    ...
    public UsuarioWS getUsuarioWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "UsuarioWSPort"), UsuarioWS.class, features);
    }
